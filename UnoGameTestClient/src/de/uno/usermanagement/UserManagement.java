...
public interface UserManagement {
    ...
    public void addUserToFriendlist(
        ...
        de.uno.usermanagement.User arg0,
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "ShowWannabeFriends", targetNamespace = "http://usermanagement.uno.de/", className = "de.uno.usermanagement.ShowWannabeFriends")
    @WebMethod(operationName = "ShowWannabeFriends")
    @ResponseWrapper(localName = "ShowWannabeFriendsResponse", targetNamespace = "http://usermanagement.uno.de/", className = "de.uno.usermanagement.ShowWannabeFriendsResponse")
    public java.lang.String showWannabeFriends(
        @WebParam(name = "arg0", targetNamespace = "")
        java.lang.String arg0
    );

    @RequestWrapper(localName = "AddNewWannabeFriend", targetNamespace = "http://usermanagement.uno.de/", className = "de.uno.usermanagement.AddNewWannabeFriend")
    @WebMethod(operationName = "AddNewWannabeFriend")
    @ResponseWrapper(localName = "AddNewWannabeFriendResponse", targetNamespace = "http://usermanagement.uno.de/", className = "de.uno.usermanagement.AddNewWannabeFriendResponse")
    public void addNewWannabeFriend(
        @WebParam(name = "arg0", targetNamespace = "")
        java.lang.String arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        java.lang.String arg1
