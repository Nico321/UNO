 ...
 * generated in the de.uno.gameconnection package. 
...
public class ObjectFactory {
     ...
     * 
     */
    public GetWishedColorResponse createGetWishedColorResponse() {
        return new GetWishedColorResponse();
    }
     ...
     * 
     */
    public SetWishedColorResponse createSetWishedColorResponse() {
        return new SetWishedColorResponse();
    }
    ...
    /**
     * Create an instance of {@link SetWishedColor }
     * 
     */
    public SetWishedColor createSetWishedColor() {
        return new SetWishedColor();
    }

    /**
     * Create an instance of {@link PutCardResponse }
     * 
     */
    public PutCardResponse createPutCardResponse() {
        return new PutCardResponse();
    }
    ...
    /**
     * Create an instance of {@link DrawCardResponse }
     * 
     */
    ...
    /**
     * Create an instance of {@link PutCard }
     * 
     */
    public PutCard createPutCard() {
        return new PutCard();
    }
    ...
    /**
     * Create an instance of {@link GetWishedColor }
     * 
     */
    public GetWishedColor createGetWishedColor() {
        return new GetWishedColor();
    }

    /**
     * Create an instance of {@link GetStackCard }
     * 
     */
    public GetStackCard createGetStackCard() {
        return new GetStackCard();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetWishedColorResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://gameconnection.uno.de/", name = "getWishedColorResponse")
    public JAXBElement<GetWishedColorResponse> createGetWishedColorResponse(GetWishedColorResponse value) {
        return new JAXBElement<GetWishedColorResponse>(_GetWishedColorResponse_QNAME, GetWishedColorResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link PutCardResponse }{@code >}}
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SetWishedColor }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://gameconnection.uno.de/", name = "setWishedColor")
    public JAXBElement<SetWishedColor> createSetWishedColor(SetWishedColor value) {
        return new JAXBElement<SetWishedColor>(_SetWishedColor_QNAME, SetWishedColor.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link DrawCard }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://gameconnection.uno.de/", name = "drawCard")
    public JAXBElement<DrawCard> createDrawCard(DrawCard value) {
        return new JAXBElement<DrawCard>(_DrawCard_QNAME, DrawCard.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetStackCard }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://gameconnection.uno.de/", name = "getStackCard")
    public JAXBElement<GetStackCard> createGetStackCard(GetStackCard value) {
        return new JAXBElement<GetStackCard>(_GetStackCard_QNAME, GetStackCard.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetWishedColor }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://gameconnection.uno.de/", name = "getWishedColor")
    public JAXBElement<GetWishedColor> createGetWishedColor(GetWishedColor value) {
        return new JAXBElement<GetWishedColor>(_GetWishedColor_QNAME, GetWishedColor.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gameconnection.uno.de/", name = "startGame")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://gameconnection.uno.de/", name = "createNewGameResponse")
