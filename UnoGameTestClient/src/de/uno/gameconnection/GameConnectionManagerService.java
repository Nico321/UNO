 ...
 * 2014-06-23T16:21:12.653+02:00
 * Generated source version: 2.7.7
 * 
 */
@WebServiceClient(name = "GameConnectionManagerService", 
                  wsdlLocation = "http://localhost:8080/UnoGame/GameConnectionManager?wsdl",
...
public class GameConnectionManagerService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/UnoGame/GameConnectionManager?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GameConnectionManagerService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/UnoGame/GameConnectionManager?wsdl");
        }
        WSDL_LOCATION = url;
    }
